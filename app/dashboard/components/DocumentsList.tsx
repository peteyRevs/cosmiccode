...
export default function DocumentsList({ initialDocuments, projects }: DocumentsListProps) {
      ...
      {filteredDocuments && filteredDocuments.length > 0 ? (
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-12 border border-white/20 shadow-xl text-center">
          ...
          <p className="text-slate-400 text-lg">
            {initialDocuments.length === 0 ? 'No documents yet' : 'No documents match your search'}
          </p>
